...
public class UIGameJoyStick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler 
{
		...
		{
			OnDrag(ped);
			UIGame.Instance.OnJoyStickDrag = true;
		}
		public virtual void OnPointerUp(PointerEventData ped) 
		{
			inputVector = Vector3.zero;
			joyStickImage.rectTransform.anchoredPosition = inputVector;
			UIGame.Instance.OnJoyStickDrag = false;
		}
